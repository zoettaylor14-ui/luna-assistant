      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        <Section title="3. Data We Collect">
          ...
          <ul style={{ paddingLeft: 20, display: 'flex', flexDirection: 'column', gap: 10 }}>
            ...
            <li><strong style={{ color: '#C9A96E' }}>Financial Data</strong> — If you import bank CSV files or connect via Plaid, transaction data (amounts, dates, merchant names) is stored in your private database for budgeting insights.</li>
        ...
        <Section title="5. Third-Party Services">
          ...
          <ul style={{ paddingLeft: 20, display: 'flex', flexDirection: 'column', gap: 10 }}>
            ...
            <li><strong style={{ color: '#C9A96E' }}>Plaid</strong> — Optionally used for bank account connection. Governed by <a href="https://plaid.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer" style={{ color: '#8B9FD4' }}>Plaid&apos;s Privacy Policy</a>.</li>
