  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
        {icon}
        <span style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.38)' }}>{text}</span>
      </div>
      {action && <button onClick={onAction} style={{ fontSize: 11, color: 'rgba(139,111,184,0.8)', fontWeight: 600, background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}>{action}</button>}
    </div>
  )
}
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 9, minWidth: 100 }}>
        ...
        <span style={{ fontFamily: 'var(--font-display)', fontSize: 16, fontWeight: 700, letterSpacing: '0.22em', color: 'white' }}>LUNA</span>
      </div>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 4 }}>
          <span style={{ fontSize: 24, fontWeight: 700, color: 'white', letterSpacing: '-0.02em', lineHeight: 1 }}>{timePart}</span>
          <span style={{ fontSize: 12, fontWeight: 600, color: 'rgba(255,255,255,0.52)' }}>{ampm}</span>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 1 }}>
          <span style={{ fontSize: 10, color: 'rgba(255,255,255,0.38)' }}>{dateStr}</span>
          <span style={{ width: 1, height: 7, background: 'rgba(255,255,255,0.2)' }} />
          <span style={{ fontSize: 10, color: 'rgba(255,255,255,0.48)' }}>{moon.emoji} {moon.name}</span>
        </div>
      </div>
      <div style={{ display: 'flex', alignItems: 'center', gap: 7, minWidth: 100, justifyContent: 'flex-end' }}>
        ...
        <Link href="/profile" style={{ display: 'flex' }}>
          <div style={{ width: 30, height: 30, borderRadius: '50%', background: 'linear-gradient(135deg, #8B6FB8, #6A4F9B)', border: '2px solid rgba(139,111,184,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <span style={{ color: 'white', fontSize: 11, fontWeight: 700 }}>Z</span>
          </div>
        </Link>
      </div>
    </div>
      ...
      {ITEMS.map((item) => {
        ...
        return (
          <button key={item.label}
            ...
            <span style={{ fontSize: 9, fontWeight: active ? 700 : 500, color: active ? 'rgba(196,169,232,0.95)' : 'rgba(255,255,255,0.48)', lineHeight: 1 }}>
              {item.label}
            </span>
          </button>
        )
    ...
    <div style={PAGE}>
      ...
      <div style={{ ...CARD, padding: '14px 18px', flexShrink: 0, position: 'relative',
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '72%' }}>
          <p style={{ fontSize: 10, color: 'rgba(255,255,255,0.32)', marginBottom: 3 }}>{dateStr}</p>
          <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 19, fontWeight: 700, color: 'white', marginBottom: 3 }}>
            {getGreeting(hour)}, Zoe ✦
          </h1>
          <p style={{ fontSize: 11, color: 'rgba(196,169,232,0.8)' }}>{moon.emoji} {moon.name} · {moon.energy}</p>
        </div>
      </div>
        ...
        <div style={{ ...CARD, padding: '12px 16px', background: 'rgba(139,111,184,0.09)', border: '1px solid rgba(139,111,184,0.22)' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
              ...
              <span style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(196,169,232,0.55)' }}>Plan My Day</span>
            </div>
          ...
          <div style={{ display: 'flex' }}>
            {[
              ...
              <div key={a.label} style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', position: 'relative' }}>
                ...
                <span style={{ fontSize: 12, marginBottom: 3 }}>{a.emoji}</span>
                <span style={{ fontSize: 12, fontWeight: 700, color: 'white' }}>{a.time}</span>
                <span style={{ fontSize: 10, color: 'rgba(255,255,255,0.38)', marginTop: 1 }}>{a.label}</span>
              </div>
            ))}
          </div>
          <div style={{ marginTop: 10, padding: '7px 12px', borderRadius: 10, background: 'rgba(139,111,184,0.18)', border: '1px solid rgba(139,111,184,0.28)', textAlign: 'center', color: 'rgba(196,169,232,0.9)', fontSize: 11, fontWeight: 600 }}>
            Build full schedule →
          </div>
        </div>
      </Link>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, flex: 1, minHeight: 0 }}>
        <div style={{ ...CARD, padding: 14, background: 'rgba(90,63,136,0.1)', border: '1px solid rgba(139,111,184,0.18)', overflow: 'hidden' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8 }}>
            ...
            <span style={{ fontSize: 9, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(196,169,232,0.5)' }}>Energy</span>
          </div>
          {gLoading ? (
        ...
        <div style={{ ...CARD, padding: 14, background: 'rgba(90,120,164,0.08)', border: '1px solid rgba(90,138,164,0.2)', overflow: 'hidden' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8 }}>
            <span style={{ fontSize: 13 }}>💎</span>
            <span style={{ fontSize: 9, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(120,180,210,0.55)' }}>Crystal</span>
          </div>
          {gLoading ? (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 5 }}><Shimmer h={12} w="65%" /><Shimmer h={9} /><Shimmer h={9} w="80%" /></div>
          ) : (
            <>
              <p style={{ fontSize: 12, fontWeight: 700, color: 'white', marginBottom: 4 }}>{guidance?.crystal ?? 'Black Tourmaline'}</p>
              <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.5)', lineHeight: 1.5 }}>{guidance?.crystal_why ?? 'Protection and grounding for your Scorpio energy today.'}</p>
            </>
          )}
        </div>
      </div>
    ...
    <div style={PAGE}>
      ...
      <Link href="/astrology/daily" style={{ textDecoration: 'none', flexShrink: 0 }}>
        <div style={{ ...CARD, padding: '12px 16px', background: 'rgba(201,169,110,0.07)', border: '1px solid rgba(201,169,110,0.18)' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
              <span style={{ fontSize: 13 }}>🔭</span>
              <span style={{ fontSize: 9, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(201,169,110,0.6)' }}>Daily Horoscope</span>
            </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,2fr) minmax(0,1fr)', gap: 8, flex: 1, minHeight: 0 }}>
        ...
        <div style={{ ...CARD, padding: '14px 16px', position: 'relative', overflow: 'hidden',
          ...
          <p style={{ fontFamily: 'var(--font-display)', fontSize: 14, fontWeight: 600, color: 'white', lineHeight: 1.5, marginBottom: 4, maxWidth: '78%' }}>{q.quote}</p>
          <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.42)', marginBottom: 6 }}>{q.author}</p>
          <p style={{ fontSize: 10, color: 'rgba(196,169,232,0.6)', lineHeight: 1.5 }}>{q.astro}</p>
        ...
        <Card style={{ padding: 14, overflow: 'hidden' }}>
          ...
          {[
            ...
            <div key={it.planet} style={{ display: 'flex', gap: 8, marginBottom: 10, alignItems: 'flex-start' }}>
              <div style={{ width: 24, height: 24, borderRadius: 7, background: `${it.c}22`, border: `1px solid ${it.c}33`, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, fontSize: 11 }}>{it.emoji}</div>
              <div>
                <p style={{ fontSize: 11, fontWeight: 600, color: 'white', lineHeight: 1.3 }}>{it.planet}</p>
                <p style={{ fontSize: 10, color: 'rgba(255,255,255,0.38)', marginTop: 1 }}>{it.desc}</p>
              </div>
            </div>
          ))}
        </Card>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, flexShrink: 0 }}>
        <Link href="/work" style={{ textDecoration: 'none' }}>
          <div style={{ ...CARD, padding: 14, background: 'rgba(90,138,90,0.08)', border: '1px solid rgba(138,184,138,0.18)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8 }}>
              <span style={{ fontSize: 13 }}>✅</span>
              <span style={{ fontSize: 9, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(138,184,138,0.55)' }}>Top Task</span>
            </div>
            {topTask ? (
              <>
                <p style={{ fontSize: 12, fontWeight: 600, color: 'white', lineHeight: 1.4, marginBottom: 5 }}>{topTask.title}</p>
                {topTask.urgency_level && (
                  <span style={{ fontSize: 10, fontWeight: 700, padding: '2px 7px', borderRadius: 5, background: 'rgba(138,184,138,0.15)', color: '#8AB88A' }}>{topTask.urgency_level}</span>
                )}
              </>
            ) : (
        ...
        <Link href="/journal" style={{ textDecoration: 'none' }}>
          <div style={{ ...CARD, padding: 14, background: 'rgba(160,130,90,0.08)', border: '1px solid rgba(201,169,110,0.18)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8 }}>
              <span style={{ fontSize: 13 }}>📓</span>
              <span style={{ fontSize: 9, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(201,169,110,0.55)' }}>Journal</span>
            </div>
            {gLoading ? (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}><Shimmer h={10} /><Shimmer h={10} w="88%" /></div>
            ) : (
              <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.7)', lineHeight: 1.55, fontStyle: 'italic' }}>
  ...
  return (
    <div style={PAGE}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 8, flex: 1, minHeight: 0 }}>
        ...
        <Card style={{ padding: 14, overflow: 'hidden' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 7, marginBottom: 10, flex: 1 }}>
            ...
            {dataLoaded && calEvents.length === 0 && (
              <p style={{ fontSize: 10, color: 'rgba(255,255,255,0.3)', fontStyle: 'italic', lineHeight: 1.5 }}>No events today — connect Google Calendar in Settings</p>
            )}
            {dataLoaded && calEvents.map((ev, i) => (
              <div key={ev.id} style={{ display: 'flex', gap: 7, alignItems: 'flex-start' }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <p style={{ fontSize: 11, fontWeight: 600, color: 'white', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{ev.title}</p>
                  <span style={{ fontSize: 9, color: 'rgba(255,255,255,0.35)' }}>{ev.startTime}</span>
                </div>
              </div>
            ))}
          </div>
          <Link href="/calendar"><div style={{ padding: '6px 10px', borderRadius: 10, background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.09)', color: 'rgba(255,255,255,0.6)', fontSize: 10, textAlign: 'center' }}>View Full Calendar →</div></Link>
        </Card>
        ...
        <Card style={{ padding: 14, overflow: 'hidden' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 7, marginBottom: 10 }}>
            ...
            {dataLoaded && topTasks.length === 0 && (
              <p style={{ fontSize: 10, color: 'rgba(255,255,255,0.3)', fontStyle: 'italic' }}>No open tasks — add some in Tasks</p>
            )}
            {dataLoaded && topTasks.slice(0, 4).map(t => {
              ...
              return (
                <div key={t.id} style={{ display: 'flex', gap: 7, alignItems: 'center' }}>
                  ...
                  <span style={{ flex: 1, fontSize: 11, color: 'rgba(255,255,255,0.78)', lineHeight: 1.3, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{t.title}</span>
                  <span style={{ fontSize: 9, fontWeight: 600, padding: '1px 5px', borderRadius: 4, background: `${color}22`, color, flexShrink: 0 }}>{urg}</span>
                </div>
              )
            })}
          </div>
          <Link href="/tasks"><div style={{ padding: '6px 10px', borderRadius: 10, background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.09)', color: 'rgba(255,255,255,0.6)', fontSize: 10, textAlign: 'center' }}>View All Tasks →</div></Link>
        </Card>
        ...
        <Card style={{ padding: 14, overflow: 'hidden' }}>
          ...
          {!emailStats.connected && dataLoaded ? (
            <p style={{ fontSize: 10, color: 'rgba(255,255,255,0.3)', fontStyle: 'italic', marginBottom: 10 }}>Connect Gmail in Settings to see your inbox here</p>
          ) : (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 9, marginBottom: 10 }}>
              {[
                ...
                <div key={r.label} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <span style={{ fontSize: 14, fontWeight: 700, color: r.c }}>{!dataLoaded ? '—' : r.count === null ? '—' : r.count}</span>
                </div>
              ))}
            </div>
          )}
          <Link href="/email"><div style={{ padding: '6px 10px', borderRadius: 10, background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.09)', color: 'rgba(255,255,255,0.6)', fontSize: 10, textAlign: 'center' }}>Open Inbox →</div></Link>
        </Card>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 8, flex: 1, minHeight: 0 }}>
        {/* DRYP Hub */}
        <Card style={{ padding: 14, overflow: 'hidden' }}>
          <WL icon={<div style={{ width: 16, height: 16, borderRadius: 4, background: 'linear-gradient(135deg, #8B6FB8, #5A3F88)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 9, fontWeight: 800, color: 'white' }}>D</div>} text="DRYP Hub" />
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginBottom: 10 }}>
            {[{ v: '15', l: 'Active Projects' }, { v: '32', l: 'Open Tasks' }, { v: '6', l: 'Due Today' }, { v: '4', l: 'Due This Week' }].map(s => (
              <div key={s.l} style={{ textAlign: 'center' }}>
                ...
                <p style={{ fontSize: 9, color: 'rgba(255,255,255,0.4)', marginTop: 2 }}>{s.l}</p>
              </div>
            ))}
          </div>
          <Link href="/work"><div style={{ padding: '6px 10px', borderRadius: 10, background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.09)', color: 'rgba(255,255,255,0.6)', fontSize: 10, textAlign: 'center' }}>Open DRYPHub →</div></Link>
        </Card>

        {/* Communication Coach */}
        <Card style={{ padding: 14, overflow: 'hidden' }}>
          <WL icon={<MessageCircle className="h-3 w-3" style={{ color: 'rgba(139,111,184,0.65)' }} />} text="Communication Coach" />
          <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.78)', lineHeight: 1.55, marginBottom: 10, fontStyle: 'italic' }}>
            &ldquo;You&apos;re in a good place to lead today. Listen more, respond less, and speak only what moves the needle.&rdquo;
          </p>
          <Link href="/messages"><div style={{ padding: '6px 10px', borderRadius: 10, background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.09)', color: 'rgba(255,255,255,0.6)', fontSize: 10, textAlign: 'center' }}>Open Messages →</div></Link>
        </Card>
            ...
            {[
              ...
              <Link key={a.l} href={a.href}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 5, padding: '7px 8px', borderRadius: 9, background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.08)' }}>
                  ...
                  <span style={{ fontSize: 10, color: 'rgba(255,255,255,0.7)', fontWeight: 500 }}>{a.l}</span>
                </div>
              </Link>
            ))}
          </div>
    ...
    <div style={PAGE}>
      ...
      <div style={{ ...CARD, padding: '14px 18px', flexShrink: 0, position: 'relative',
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '75%' }}>
          <WL icon={<span style={{ fontSize: 12 }}>✦</span>} text="Today's Cosmic Weather" />
          <p style={{ fontFamily: 'var(--font-display)', fontSize: 17, fontWeight: 700, color: 'white', marginBottom: 3 }}>{moon.emoji} {moon.name}</p>
          <p style={{ fontSize: 11, color: 'rgba(196,169,232,0.82)' }}>{moon.energy}</p>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 8, flex: 1, minHeight: 0 }}>
        {[
          ...
          <Card key={c.href} href={c.href} style={{ padding: 14, overflow: 'hidden' }}>
            ...
            <p style={{ fontSize: 12, fontWeight: 700, color: 'white', marginBottom: 2 }}>{c.label}</p>
            <p style={{ fontSize: 10, color: 'rgba(255,255,255,0.42)' }}>{c.sub}</p>
          </Card>
        ))}
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 8, flexShrink: 0 }}>
        {[
          ...
          <Card key={c.href} href={c.href} style={{ padding: 12, textAlign: 'center', overflow: 'hidden' }}>
            ...
            <p style={{ fontSize: 10, fontWeight: 600, color: 'rgba(255,255,255,0.72)' }}>{c.label}</p>
          </Card>
        ))}
      </div>
    </div>
  ...
  return (
    <div style={PAGE}>
      <div style={{ ...CARD, padding: '14px 18px', flexShrink: 0, background: 'linear-gradient(155deg, #18103a 0%, #281560 40%, #14082e 100%)' }}>
        <WL icon={<span style={{ fontSize: 12 }}>✦</span>} text="Highest Self Mirror" />
        <p style={{ fontFamily: 'var(--font-display)', fontSize: 16, fontWeight: 700, color: 'white', marginBottom: 4 }}>What would the highest version of you do today?</p>
        <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.48)', lineHeight: 1.55, marginBottom: 10 }}>She moves with intention. She speaks only when it serves. She rests without guilt and leads without force.</p>
        <Link href="/highest-self">
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 4, padding: '6px 12px', borderRadius: 10, background: 'rgba(139,111,184,0.25)', border: '1px solid rgba(139,111,184,0.35)', color: 'rgba(255,255,255,0.9)', fontSize: 11, fontWeight: 600 }}>
  ...
  return (
    <div style={PAGE}>
      <div style={{ ...CARD, padding: '14px 18px', flexShrink: 0, background: 'linear-gradient(135deg, #28082a 0%, #38103e 35%, #180826 75%, #100618 100%)' }}>
        ...
        <p style={{ fontFamily: 'var(--font-display)', fontSize: 16, fontWeight: 700, color: 'white', marginBottom: 4 }}>✂ Atelier Mode Active</p>
        <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.48)', lineHeight: 1.55, marginBottom: 10 }}>Cancer Moon calls for softness in fabric and form. Flowing lines, plush textures, colors that feel like safety.</p>
        <Link href="/atelier">
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 4, padding: '6px 12px', borderRadius: 10, background: 'rgba(200,140,160,0.2)', border: '1px solid rgba(200,140,160,0.3)', color: 'rgba(255,255,255,0.9)', fontSize: 11, fontWeight: 600 }}>
